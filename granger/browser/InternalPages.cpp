...
--ds-control-height-sm:__CONTROL_HEIGHT_SM__;--ds-shadow-popup:0 18px 50px rgba(0,0,0,.42);
--ds-fast:__HOVER_DURATION__;--ds-normal:__POPUP_DURATION__
}
html{overflow-x:hidden;scrollbar-width:thin;scrollbar-color:#5b5e69 transparent}
...
::-webkit-scrollbar-thumb{min-height:34px;border:2px solid transparent;border-radius:999px;background:#565964;background-clip:padding-box}
::-webkit-scrollbar-thumb:hover{background:#727681;background-clip:padding-box}
::-webkit-scrollbar-button{display:none;width:0;height:0}
@media(max-width:760px){main{padding:26px 20px 56px}main>header h1{font-size:28px}}
@media(prefers-reduced-motion:reduce){
button,.button,input,select,textarea,input[type=checkbox],input[type=checkbox]::before,summary::after{transition:none!important}
}
</style>)CSS"));
...
html.settings-page{overflow-x:clip;overflow-anchor:none;scrollbar-gutter:stable;scrollbar-color:#697180 rgba(10,12,15,.18);scrollbar-width:thin}body.settings-page{overflow-x:clip;overflow-anchor:none}.settings-page *{scrollbar-color:#697180 rgba(10,12,15,.18);scrollbar-width:thin}.settings-page::-webkit-scrollbar,.settings-page *::-webkit-scrollbar{width:var(--scrollbar-size);height:var(--scrollbar-size)}.settings-page::-webkit-scrollbar-track,.settings-page *::-webkit-scrollbar-track{background:rgba(10,12,15,.18)}.settings-page::-webkit-scrollbar-thumb,.settings-page *::-webkit-scrollbar-thumb{min-height:36px;border:2px solid transparent;border-radius:999px;background:#626a78;background-clip:padding-box}.settings-page::-webkit-scrollbar-thumb:hover,.settings-page *::-webkit-scrollbar-thumb:hover{background:#7a8494;background-clip:padding-box}.settings-page::-webkit-scrollbar-thumb:active,.settings-page *::-webkit-scrollbar-thumb:active{background:#8e99aa;background-clip:padding-box}.settings-page::-webkit-scrollbar-button,.settings-page *::-webkit-scrollbar-button{display:none;width:0;height:0}.settings-page::-webkit-scrollbar-corner,.settings-page *::-webkit-scrollbar-corner{background:transparent}
...
.settings-page .config-transfer{margin-top:28px;padding-top:16px}.settings-page .config-transfer>summary{font-size:15px;font-weight:600;color:var(--text)}.settings-page .config-transfer-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:0;margin-top:16px;border-top:1px solid var(--line);border-bottom:1px solid var(--line)}.settings-page .config-transfer-group{min-width:0;padding:18px 18px 18px 0}.settings-page .config-transfer-group+ .config-transfer-group{padding-left:18px;padding-right:0;border-left:1px solid var(--line)}.settings-page .config-transfer-title{margin:0 0 12px;color:var(--text);font-size:13px;font-weight:600}.settings-page .config-transfer-actions{display:flex;align-items:stretch;gap:var(--space-md);flex-wrap:wrap}.settings-page .config-transfer-actions .button{flex:0 1 auto}.settings-page .config-export-form{display:grid;gap:14px;justify-items:start}.settings-page .check-row{display:flex;align-items:flex-start;gap:10px;min-height:var(--control-height);padding:8px 0;color:var(--text);line-height:1.45;cursor:pointer}.settings-page .check-row span{min-width:0;overflow-wrap:anywhere}.settings-page .config-preview{margin-top:14px;min-width:0;overflow-wrap:anywhere}
    ...
    html.settings-page,.settings-page *{scrollbar-color:#71696b rgba(10,12,15,.18)}.settings-page::-webkit-scrollbar-thumb,.settings-page *::-webkit-scrollbar-thumb{background:#686164;background-clip:padding-box}.settings-page::-webkit-scrollbar-thumb:hover,.settings-page *::-webkit-scrollbar-thumb:hover{background:#81777a;background-clip:padding-box}.settings-page::-webkit-scrollbar-thumb:active,.settings-page *::-webkit-scrollbar-thumb:active{background:#94878b;background-clip:padding-box}.settings-page .ds-select-trigger:hover{border-color:#554b4e}.settings-page .ds-listbox{border-color:#4b4547;background:#262326}.settings-page .ds-option:hover,.settings-page .ds-option[data-active=true]{border-color:#4a4244}.settings-page .ds-option[aria-selected=true]::after{border-right-color:#e19aa1;border-bottom-color:#e19aa1}.settings-page .ds-select-trigger:disabled,.settings-page .ds-option[aria-disabled=true]{color:#777174}
